...
namespace FizjoTermWeb.Controllers
{
    public class VisitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdVisit,IdPhysiotherapist,IdReferral,VisitDate,VisitTime,DateSaved,VisitCompleted")] Visit visit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdVisit,IdPhysiotherapist,IdReferral,VisitDate,VisitTime,DateSaved,VisitCompleted")] Visit visit)
        {
            if (ModelState.IsValid)
            {
